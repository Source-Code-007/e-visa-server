...
const getAllVisa = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const visa = yield visa_service_1.visaServices.getAllVisa();
    (0, sendResponse_1.default)(res, http_status_codes_1.StatusCodes.OK, {
        success: true,
...
const getSingleVisa = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const visa = yield visa_service_1.visaServices.getSingleVisa((_a = req.params) === null || _a === void 0 ? void 0 : _a.referenceNumber);
    if (!visa) {
...
const deleteVisa = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _b;
    const visa = yield visa_service_1.visaServices.deleteVisa((_b = req.params) === null || _b === void 0 ? void 0 : _b.id);
    (0, sendResponse_1.default)(res, http_status_codes_1.StatusCodes.OK, {
        success: true,
